    ...
    <div className="preview w-full h-full flex" ref={ref}>
        <div className="side-left overflow-hidden w-[120px] sm:w-[270px] bg-blue-950 min-h-full">
            ...
            <div className="contact px-3 mt-9 text-slate-50">
                <h3 className='text-[12px] sm:text-[22px] font-[600] mb-3 border-b-2 border-slate-50 tracking-[2px] uppercase'>Contact</h3>
                <p className='mb-3 w-full overflow-hidden text-[8px] sm-text-[10px] flex items-center gap-3'><FaPhone /> <div className='font-[600] max-w-[180px]'>{personnalInfo.telephone}</div></p>
                <p className='mb-3 w-full overflow-hidden text-[8px] sm-text-[10px] flex items-center gap-3'><MdEmail /> <div className='font-[600] max-w-[180px]'>{personnalInfo.email}</div></p>
                <p className='mb-3 w-full overflow-hidden text-[8px] sm-text-[10px] flex items-center gap-3'><MdLocationPin /> <div className='font-[600] max-w-[180px]'>{personnalInfo.adresse}</div></p>
            </div>
            <div className="skills px-3 mt-4 text-slate-50">
                <h3 className='text-[12px] sm:text-[22px] font-[600] mb-2 border-b-2 border-slate-50 tracking-[2px] uppercase'>skills</h3>
                <ul>
                {skills.map((skill)=>(
            ...
            <div className="languages px-3 mt-4 text-slate-50">
                <h3 className='text-[12px] sm:text-[22px] font-[600] mb-2 border-b-2 border-slate-50 tracking-[2px] uppercase'>languages</h3>
                <ul>
                {languages.map((lang)=>(
        ...
        <div className="side-right bg-slate-50 text-slate-700 min-h-full w-[180px] sm:w-[530px]">
           ...
           <div className="profile px-3 mt-9 text-slate-700">
                <h3 className='text-[12px] sm:text-[22px] font-[600] mb-2 border-b-2 border-slate-700 tracking-[2px] uppercase'>profile</h3>
            ...
            <div className="educations px-3 mt-4 text-slate-700">
                <h3 className='text-[12px] sm:text-[22px] font-[600] mb-2 border-b-2 border-slate-700 tracking-[2px] uppercase'>educations</h3>
                <ul>
                {educations?.map((edu)=>(
            ...
            <div className="experiences px-3 mt-4 text-slate-700">
                <h3 className='text-[12px] sm:text-[22px] font-[600] mb-2 border-b-2 border-slate-700 tracking-[2px] uppercase'>experiences</h3>
                <ul>
                {experiences?.map((exp)=>(
